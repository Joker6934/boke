         ...
         @if($n->art_status == 1)
          ...
          <article class="home-blog-entry clr">
           ...
           <div class="postlist-meta">
            ...
            <span class="delim"></span>
            <div class="postlist-meta-like like like-no" uid="1" artid="{{ $n->art_id }}" style="float:right;cursor:default;" title="点击喜欢">
{{--             <i class="fa fa-heart"></i>&nbsp;--}}
{{--             <span>34</span>&nbsp;--}}
            </div>
            <div class="postlist-meta-collect collect collect-no" uid="1" artid="{{ $n->art_id }}" style="float:right;cursor:default;" title="点击收藏">
